...
<div class="container">
    <form id='printAck_form_in' action="" method="post" enctype="multipart/form-data">
...
?> 
                            ...
                            <input type="hidden" id="type" name="status_type" value="1">
                        </table>
                    </div></div>
...
<?php  } ?>
                    ...
                    <div class="row"> 
                        <div class="col-md-4 form-group">
                            ...
                            <div>
                                <input type="file" name="support_doc" value="" accept=".png,.jpeg,.jpg,.pdf,.doc,.docx" />
                             </div>
                        </div> 
                        <div class="col-md-4 form-group" align="center">
                            ...
                            <div>
                            &nbsp;<input type="file" name="img_doc" accept=".png,.jpeg,.jpg" value="" />
                             </div>
                        </div> 
                        <div class="col-md-4 form-group" align="center">
                            <div class="full field">
                            ...
                            <div>
                            &nbsp; <input type="file" name="video_doc" value="" accept="video/*"/>
                             </div>
                        </div>
                    </div>
