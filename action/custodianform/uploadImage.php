            ...
            $err = 1; 
			  ...
			  if ($tmpFilePath != ""){
			    ...
			    if(move_uploaded_file($tmpFilePath, $newFilePath)) {
					$qry = "insert into tbl_custodian_upload(m_id,doc_nm,doc_size,doc_data,doc_type,created_at,status)values('$m_id','$efilenm','$filesize','$imgContent','I',CURRENT_TIMESTAMP,1)";
