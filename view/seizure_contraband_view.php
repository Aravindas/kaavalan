...
<table class="table table-striped table-hover" cellspacing="0" id="example" >
    <thead>
        <tr>
            <th>Sl.No.</th>
            <th>Contraband Code</th>
            <th>Contraband Name</th>
            <th>Contraband Quantity Type</th>
            <th>Contraband Units</th>
            <th>Storage Mode</th>
    ...
    <tbody>
<?php 
$_SESSION['mip']="seizure_contraband"; 
include('../getData.php');
...
?>
        <tr>
            <td><?php echo ++$i; ?></td>
            <td><?php echo base64_decode($data['contraband_code']); ?></td>
            <td><?php echo base64_decode($data['contraband_type_name']); ?></td>
            <td><?php echo base64_decode($data['contraband_quantity_type']); ?> </td>
            <td><?php echo base64_decode($data['contraband_units']); ?></td>
            <td><?php echo base64_decode($data['storage_mode']); ?></td>
