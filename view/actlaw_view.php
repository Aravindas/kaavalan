...
<table class="table table-striped table-hover" cellspacing="0" id="example" >
    <thead>
        <tr>
            <th>Sl.No.</th>
            <th>Section Act</th>
            <th>Section Act Code</th>
            <th>Section Act Description</th>
            <th>Section Law</th>
            <th>Section Law Code</th>
            <th>Section Law Description</th>
...
?>
        <tr>
            <td><?php echo ++$i; ?></td>
            <td><?php echo base64_decode($data['section_act']); ?></td>
            <td><?php echo base64_decode($data['section_act_code']); ?></td>
            <td><?php echo base64_decode($data['section_act_description']); ?> </td>
            <td><?php echo base64_decode($data['section_law']); ?></td>
            <td><?php echo base64_decode($data['section_law_code']); ?></td>
            <td><?php echo base64_decode($data['section_law_description']); ?></td>
